<?php
	...
	if (isset($_POST['email'])) {
		...
		$email_to = "m.krazynski@outlook.com";
		$email_subject = "My offer for viarity.com";
...
<html lang="en">
		<head>
				<meta charset="utf-8">
				<title>Sales Inquery || viarity.com</title>
									...
									<section class="bg-alt">
											<div class="row height-100">
													<div class="col-sm-8 offset-sm-2 mt-2">
														<h1 class="pt-4 h2"><span class="text-green">Innovatikon</span></h1>
														<span class="text-muted">Gdynia, Poland</span>
														<br/>
